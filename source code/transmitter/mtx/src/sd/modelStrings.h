...
const id_string_t enum_ModelType[] PROGMEM = { //array of structs in PROGMEM
...
const id_string_t enum_TelemetryAlarmCondition[] PROGMEM = {
  {TELEMETRY_ALARM_CONDITION_NONE, "None"},
...
const id_string_t enum_WidgetDisplay[] PROGMEM = {
  ...
  {WIDGET_DISP_GAUGE_ZERO_CENTERED, "GaugeZeroCenter"},
  {0, ""}
};
...
//Duplicates should be commented out. 
