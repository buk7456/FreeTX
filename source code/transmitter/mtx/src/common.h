...
typedef struct {
  ...
  //--- sound
  bool     soundEnabled; 
  bool     soundTrims;  //TODO Better names
  bool     soundSwitches;
...
enum { 
  ...
  LS_FUNC_DELTA_GREATER_THAN_X,
  LS_FUNC_ABS_DELTA_GREATER_THAN_X,
  LS_FUNC_GROUP1_LAST = LS_FUNC_ABS_DELTA_GREATER_THAN_X,
  ...
  LS_FUNC_GROUP2_LAST = LS_FUNC_A_LESS_THAN_OR_EQUAL_B,
  
  LS_FUNC_AND,
  LS_FUNC_OR,
  LS_FUNC_XOR,
  LS_FUNC_LATCH,
  LS_FUNC_GROUP3_LAST = LS_FUNC_LATCH,
  
  LS_FUNC_TOGGLE,
  LS_FUNC_GROUP4_LAST = LS_FUNC_TOGGLE,
  
  LS_FUNC_PULSE,
  LS_FUNC_GROUP5_LAST = LS_FUNC_PULSE,
...
typedef struct {
  ...
  //--- Safety checks
  bool   checkThrottle;
  int8_t switchWarn[MAX_NUM_PHYSICAL_SWITCHES]; //-1 means no checks //TODO Better name
